...
require (
	...
	github.com/koinos/koinos-proto-golang/v2 v2.0.2-0.20240326155010-7093c73d96a4 // indirect
	github.com/koinos/koinos-util-golang v1.0.0
	github.com/koinos/koinos-util-golang/v2 v2.0.1-0.20240326163418-f3fe2cd5d271 // indirect
